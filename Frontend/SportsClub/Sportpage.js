...
import Spobanner from "./Spobanner";
import {
  Link,
  Navigate,
  ...
  function SportPage() {
    ...
    return (
        <div>
          <Spoheader/>
        <Link to="/Sports/ClubRegistration" style={lin}>Register for Club</Link>
        <Link to="/Sports/Admin">Admin Portal</Link>
  ...
  render() {
      ...
      return (
          <tr class="table_row">
             ...
             <p> <Link to="/Sports/EventRegistration" state={{ eventname: row1.name }} style={divStyle}>Register</Link>
              <Link to="/Sports/EventVolunteer" state={{ eventname: row1.name }}>Volunteer</Link></p>
