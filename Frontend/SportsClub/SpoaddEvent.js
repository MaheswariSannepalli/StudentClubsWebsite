...
function SpoAddEvent() {
      ...
      function add(e) {
        ...
        axios.defaults.headers.post['Access-Control-Allow-Origin'] = '*';
          axios({
            method: "post",
            url: "http://localhost:8080/spoevents",
            data: formData,
    ...
    const lin = {
      ...
      return (
        ...
        <form class="form-reg" encType="multipart/form-data" onSubmit={add} >
              ...
              <Link to="/Sports/Admin/ViewCoordinators/ViewEvents" style={lin}>VIEW EVENTS</Link>      
              </form>
        {status } <br></br>
