...
import { hover } from "@testing-library/user-event/dist/hover";
  ...
  function SpoAdmin() {
    ...
    function loginAdminApiFunction(e) {
        ...
        axios.get(`http://localhost:8080/spoadmin/${coid}`)
          .then(res => {
    ...
    return (
        ...
        <Spoheader/>
          ...
          status && <Alert  variant="success">
            ...
            <Navigate to="/Sports/Admin/ViewCoordinators" />
          </Alert>}
      ...
      {status && <Link  to="/Sports/Admin/ViewCoordinators">View Coordinators</Link>}
