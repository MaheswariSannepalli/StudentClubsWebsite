...
import Footer from '../../footer';
  ...
  function SpoRegister() {
    ...
    function registerStudentApiFunction(e) {
        ...
        axios.post(`http://localhost:8080/spostudents`, postData)
     .then(res => {
    ...
    return (
      ...
      status && <Alert  variant="success">
        ...
        <input type="password" placeholder="Set password" value={password} onChange={(e)=>setPassword(e.target.value)}/>
                    ...
                    {status && <div className="App" > <Link  to="/Sports" style={buttn}>Go Back</Link> </div>}
                </Col>
            </Row></Container>
        <Footer/>
