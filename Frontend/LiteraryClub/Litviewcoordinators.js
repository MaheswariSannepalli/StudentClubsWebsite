        ...
        <div >
           ...
           {body &&
            <div style = {divStyle}>
                 ...
                 <br></br>
                 <div class="App">
        <Link to="/Literary/Admin/ViewCoordinators/Add" style={butngap}>ADD ADMIN</Link>
...
class TableRow extends Component {
    ...
    {
            axios.delete(`http://localhost:8080/litadmin/${row.coid}`)
            .then(res => {
              console.log(res.data);
              })
             return(
    ...
    const del = {
        ...
        return (
            <tr>
                ...
                <td>  
                <Link to="/Literary/Admin/ViewCoordinators/Edit" state={{ cordid: row.coid,
                                                                          cordname:row.coname,
                                                                          corddept: row.codept,
                                                                          cordrole:row.corole,
...
export default LitViewCoordinators;