...
function RobcoordinateEdit(){
    ...
    console.log("received values",cordid);
      const [status, setStatus] = useState(false);
        ...
        function Edit(e) {
            ...
            axios.put(`http://localhost:8080/robadmin/edit/${coid}`, editData)
         .then(res => {
    ...
    return(
        ...
        <form class="form-reg">
              ...
              <Link  to="/Robotics/Admin/ViewCoordinators" style={lin}>View Coordinators</Link>
              </form>
        {status } <br></br>
...
export default RobcoordinateEdit;