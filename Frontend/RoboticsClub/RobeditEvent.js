...
function RobeditEdit(){
    ...
    const [status, setStatus] = useState(false);
        ...
        function Edit(e) {
            ...
            axios.put(`http://localhost:8080/robevent/event/${name}`, editData)
         .then(res => {
    ...
    return(
        ...
        <form class="form-reg" >
              ...
              <Link  to="/Robotics/Admin/ViewCoordinators/ViewEvents" style={lin}>View Events</Link>
              </form>
        {status } <br></br>
