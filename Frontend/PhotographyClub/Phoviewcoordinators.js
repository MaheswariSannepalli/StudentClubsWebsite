        ...
        <div >
           ...
           {body &&
            <div style = {divStyle}>
                 ...
                 <br></br>
                 <div class="App">
        <Link to="/Photography/Admin/ViewCoordinators/Add" style={butngap}>ADD ADMIN</Link>
        <Link to="/Photography/Admin/ViewCoordinators/ViewEvents">VIEW EVENTS</Link>   
        </div>  
        <Footer2/> 
        </div>
      );
...
class TableRow extends Component {
    ...
    {
            axios.delete(`http://localhost:8080/phoadmin/${row.coid}`)
            .then(res => {
              console.log(res.data);
              })
             return(
    ...
    const del = {
        ...
        return (
            <tr>
                ...
                <td>  
                <Link to="/Photography/Admin/ViewCoordinators/Edit" state={{ cordid: row.coid,
                                                                          cordname:row.coname,
                                                                          corddept: row.codept,
                                                                          cordrole:row.corole,
...
export default PhoViewCoordinators;